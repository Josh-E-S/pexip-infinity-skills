...
## Production receiver patterns

See [`receiver-patterns.md`](receiver-patterns.md) for complete, production-grade receiver implementations in Node.js/TypeScript (Express + Redis) and Python (FastAPI + BackgroundTasks), including idempotency strategies and out-of-order delivery handling.
